...
dependencies {
    ...
    // awssdk s3
    implementation("software.amazon.awssdk:s3:${Versions.AWS_SDK_V2}")
    implementation("software.amazon.awssdk:s3-transfer-manager:${Versions.AWS_SDK_V2_TM}")
    ...
    // scrimage
    implementation("com.sksamuel.scrimage:scrimage-core:${Versions.SCRIMAGE}")
